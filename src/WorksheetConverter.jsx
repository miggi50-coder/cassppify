      ...
      {stage === "review" && (
        <div className="no-print">
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14, flexWrap: "wrap", gap: 10 }}>
            <div style={{ fontSize: 14, color: C.muted }}>{questions.length} problem{questions.length !== 1 ? "s" : ""}. Change the format, delete, or regenerate any problem, then continue.</div>
            ...
            <div key={q.id} style={{ border: `1px solid ${C.border}`, borderRadius: 12, padding: 18, marginBottom: 16, background: C.white }}>
              <div style={{ display: "flex", justifyContent: "space-between", gap: 16, flexWrap: "wrap", marginBottom: 10 }}>
                ...
                <button
                  ...
                  style={{ border: "none", background: "transparent", color: "#B33", fontWeight: 700, fontSize: 13, cursor: "pointer", whiteSpace: "nowrap", padding: "2px 4px" }}
                >
                  Delete
                </button>
              </div>
          ...
          <div style={{ display: "flex", gap: 12, marginTop: 20 }}>
            ...
            <button onClick={() => setStage("export")} disabled={!questions.length} style={{ padding: "10px 18px", borderRadius: 8, border: "none", background: C.deep, color: C.white, fontWeight: 700, cursor: "pointer" }}>
